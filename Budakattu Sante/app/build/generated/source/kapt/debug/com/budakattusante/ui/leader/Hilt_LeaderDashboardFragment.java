...
public abstract class Hilt_LeaderDashboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LeaderDashboardFragment() {
    super();
  }

  Hilt_LeaderDashboardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeaderDashboardFragment_GeneratedInjector) this.generatedComponent()).injectLeaderDashboardFragment(UnsafeCasts.<LeaderDashboardFragment>unsafeCast(this));
    }
  }
