...
public abstract class Hilt_ManageProductsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ManageProductsFragment() {
    super();
  }

  Hilt_ManageProductsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManageProductsFragment_GeneratedInjector) this.generatedComponent()).injectManageProductsFragment(UnsafeCasts.<ManageProductsFragment>unsafeCast(this));
    }
  }
