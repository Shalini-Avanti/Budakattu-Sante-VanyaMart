...
public abstract class Hilt_LeaderProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LeaderProfileFragment() {
    super();
  }

  Hilt_LeaderProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeaderProfileFragment_GeneratedInjector) this.generatedComponent()).injectLeaderProfileFragment(UnsafeCasts.<LeaderProfileFragment>unsafeCast(this));
    }
  }
