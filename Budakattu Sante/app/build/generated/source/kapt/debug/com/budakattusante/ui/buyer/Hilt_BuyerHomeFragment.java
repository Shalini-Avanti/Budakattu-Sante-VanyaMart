...
public abstract class Hilt_BuyerHomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BuyerHomeFragment() {
    super();
  }

  Hilt_BuyerHomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BuyerHomeFragment_GeneratedInjector) this.generatedComponent()).injectBuyerHomeFragment(UnsafeCasts.<BuyerHomeFragment>unsafeCast(this));
    }
  }
