...
public abstract class Hilt_PreorderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PreorderFragment() {
    super();
  }

  Hilt_PreorderFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PreorderFragment_GeneratedInjector) this.generatedComponent()).injectPreorderFragment(UnsafeCasts.<PreorderFragment>unsafeCast(this));
    }
  }
