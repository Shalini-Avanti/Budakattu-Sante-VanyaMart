...
public final class ItemOrderBinding implements ViewBinding {
  ...
  private ItemOrderBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvDate,
      @NonNull TextView tvProductName, @NonNull TextView tvQuantity, @NonNull TextView tvStatus,
  ...
  public static ItemOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderBinding((MaterialCardView) rootView, tvDate, tvProductName, tvQuantity,
          tvStatus, tvTotal);
    }
