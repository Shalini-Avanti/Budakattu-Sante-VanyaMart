...
public abstract interface UserDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM users WHERE phone = :phone AND password = :password LIMIT 1")
    @org.jetbrains.annotations.Nullable()
    ...
    @androidx.room.Query(value = "SELECT COUNT(*) FROM users WHERE phone = :phone")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object phoneExists(@org.jetbrains.annotations.NotNull()
    java.lang.String phone, @org.jetbrains.annotations.NotNull()
